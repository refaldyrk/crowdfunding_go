...
func (h *transactionHandler) CreateTransaction(c *gin.Context) {
	...
	if err != nil {
		...
		response := helper.APIResponse("Transaction Failed", http.StatusUnprocessableEntity, "error", errorsMessage)
		c.JSON(http.StatusUnprocessableEntity, response)
		return
	}
	...
	response := helper.APIResponse("Transaction Success", http.StatusOK, "success", transaction.FormatTransaction(newTransaction))
	c.JSON(http.StatusOK, response)
}
